...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function updateToggleUI(theme) {
    ...
    if (theme === 'dark') {
      darkModeToggle.setAttribute('aria-label', 'Gara haala ifaa jijjiiri');
      themeIcon.setAttribute('data-lucide', 'sun');
    } else {
      darkModeToggle.setAttribute('aria-label', 'Gara haala dukkanaa jijjiiri');
  ...
  function openMenu() {
    ...
    hamburgerBtn.setAttribute('aria-label', 'Menu deemsaa cufi');
  ...
  function closeMenu() {
    ...
    hamburgerBtn.setAttribute('aria-label', 'Menu deemsaa banii');
    hamburgerBtn.focus();
  }
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (nameField && nameField.value.trim() === '') {
        if (nameError) nameError.textContent = 'Maqaan barbaachisaadha';
        hasError = true;
      ...
      if (emailField) {
        if (emailField.value.trim() === '') {
          if (emailError) emailError.textContent = 'Imeelli barbaachisaadha';
          hasError = true;
          if (!firstInvalidField) firstInvalidField = emailField;
        } else if (!emailRegex.test(emailField.value.trim())) {
          if (emailError) emailError.textContent = 'Maaloo teessoo imeelii sirrii galchi';
          hasError = true;
          if (!firstInvalidField) firstInvalidField = emailField;
        }
      }
      ...
      if (messageField && messageField.value.trim() === '') {
        if (messageError) messageError.textContent = 'Ergaan barbaachisaadha';
        hasError = true;
